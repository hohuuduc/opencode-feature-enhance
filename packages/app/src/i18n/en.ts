...
export const dict = {
  ...
  "command.usage.view": "View Go usage",
  "command.usage.view.description": "Check your OpenCode Go subscription usage",
  ...
  "dialog.usage.title": "OpenCode Go usage",
  "dialog.usage.rolling": "Rolling window",
  "dialog.usage.weekly": "Weekly limit",
  "dialog.usage.monthly": "Monthly limit",
  "dialog.usage.status.ok": "OK",
  "dialog.usage.status.rateLimited": "Rate limited",
  "dialog.usage.resetsAt": "Resets at {{time}}",
  "dialog.usage.refresh": "Refresh",
  "dialog.usage.notConnected.title": "OpenCode Go not connected",
  "dialog.usage.notConnected.description": "Connect your OpenCode Go account to view subscription usage.",
  "dialog.usage.connect.action": "Connect OpenCode Go",
  "dialog.usage.error.title": "Failed to load usage",
  "dialog.usage.error.description": "Something went wrong while loading your usage.",
